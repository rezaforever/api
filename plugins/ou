...
local text = 'â™¨ï¸ÙØ¹Ø§Ù„Ø§Ù† Ø§Ù…Ø±ÙˆØ² Ú¯Ø±ÙˆÙ‡\n1âƒ£ '..maxname[1]..'ã€–'..maxuser[1]..'ã€—\n\nðŸ“¨ØªØ¹Ø¯Ø§Ø¯ Ù¾ÛŒØ§Ù… Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ÛŒ: '..maxtex[1] + maxph[1] + maxst[1] + maxoth[1]..'\n\nðŸ‘¾Ø§Ø³ØªÛŒÚ©Ø±: '..maxst[1]..'\n\nðŸ“·ØªØµÙˆÛŒØ±: '..maxph[1]..'\n\nðŸ“ƒ Ù…ØªÙ†: '..maxtex[1]..'\n\nðŸ“¦ Ø³Ø§ÛŒØ±: '..maxoth[1]
if maxid[2] then
	if not maxid[3] then
text = text..'\n\n 2âƒ£ '..maxname[2]..' ã€–'..maxuser[2]..'ã€—\n\nðŸ“¨ØªØ¹Ø¯Ø§Ø¯ Ù¾ÛŒØ§Ù… Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ÛŒ: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\nðŸ‘¾Ø§Ø³ØªÛŒÚ©Ø±: '..maxst[2]..'\n\nðŸ“·ØªØµÙˆÛŒØ±: '..maxph[2]..'\n\nðŸ“ƒ Ù…ØªÙ†: '..maxtex[2]..'\n\nðŸ“¦ Ø³Ø§ÛŒØ±: '..maxoth[2]
else
text = text..'\n\n 2âƒ£ '..maxname[2]..' ã€–'..maxuser[2]..'ã€—\n\nðŸ“¨ØªØ¹Ø¯Ø§Ø¯ Ù¾ÛŒØ§Ù… Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ÛŒ: '..maxtex[2] + maxph[2] + maxst[2] + maxoth[2]..'\n\nðŸ‘¾Ø§Ø³ØªÛŒÚ©Ø±: '..maxst[2]..'\n\nðŸ“·ØªØµÙˆÛŒØ±: '..maxph[2]..'\n\nðŸ“ƒ Ù…ØªÙ†: '..maxtex[2]..'\n\nðŸ“¦ Ø³Ø§ÛŒØ±: '..maxoth[2]..'\n\n 3âƒ£ '..maxname[3]..' ã€–'..maxuser[3]..'ã€—\n\nðŸ“¨ØªØ¹Ø¯Ø§Ø¯ Ù¾ÛŒØ§Ù… Ù‡Ø§ÛŒ Ø§Ø±Ø³Ø§Ù„ÛŒ: '..maxtex[3] + maxph[3] + maxst[3] + maxoth[3]..'\n\nðŸ‘¾Ø§Ø³ØªÛŒÚ©Ø±: '..maxst[3]..'\n\nðŸ“·ØªØµÙˆÛŒØ±: '..maxph[3]..'\n\nðŸ“ƒ Ù…ØªÙ†: '..maxtex[3]..'\n\nðŸ“¦ Ø³Ø§ÛŒØ±: '..maxoth[3]
end
end
