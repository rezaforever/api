...
local answers = {
                   'https://assets.imgix.net/examples/clouds.jpg?blur=120&w=700&h=400&fit=crop&txt=',
	           ...
	           'https://assets.imgix.net/examples/vista.png?blur=120&w=700&h=400&fit=crop&txt='
}
